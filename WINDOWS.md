...
### 23. VSCode Integration (WSL)

If you have VSCode installed on Windows, you can use it from WSL:

1. Add VSCode to your WSL path (see **Appendix B**).
