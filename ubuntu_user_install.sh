...
# ============================================================
# NodeJS Setup (UBUNTU.md Step 13)
# ============================================================
...
echo "  2. For mypy in Sublime Text, see UBUNTU.md section 12"
echo "  3. For Terminus in Sublime Text, see UBUNTU.md section 13"
echo "  4. For Haskell LSP and Ormolu in Sublime Text, see UBUNTU.md section 15"
echo ""
