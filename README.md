...
1. **Haskell Playground** - <https://play.haskell.org/> - Quick Haskell testing in browser
2. **GitHub Codespaces (CS111 - Fundamentals of Programming Template)** - [![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/kittipitch/26cs111codespaces?quickstart=1)
...
3. **GitHub Codespaces (CS115 - Principles of Functional Programming)** - [![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/kittipitch/26cs115codespaces?quickstart=1)
...
4. **GitHub Codespaces (C/C++ Template)** - [![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/kittipitch/26CppCodespaces?quickstart=1)
   - Wait for the environment to build (includes **g++**, **gdb**, and **Microsoft C++ Extension**).
   - Use the **Play Button** to build and run your active file.
